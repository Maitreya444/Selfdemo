...
void DispayEvenElements(int iLength1, int Arr1[], int iLenght2, int Arr2[])
{
    int iCnt = 0;

    printf("Even Elements of Array 1 are : \n");
    ...
    printf("Even Elements of Array 2 are : \n");
...
int main()
{
    ...
    DispayEvenElements(iSize1, ptr1, iSize2, ptr2);
