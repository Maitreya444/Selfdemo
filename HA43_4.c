/*Accept two array from user nad copy the contents of that array into another array and return new Array*/

#include<stdio.h>
#include<stdlib.h>

int* DisplayArray(int iLength1, int Arr1[], int iLength2, int Arr2[], int *iLength3)
{
    int iCnt =0;
...
int main()
{
    ...
    ptr3 = DisplayArray(iSize1, ptr1, iSize2 , ptr2, &iSize3);
